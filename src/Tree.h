...
public:
  ...
  void init(const Data* data, uint64_t mtry, size_t num_samples, uint64_t seed, std::vector<size_t>* deterministic_varIDs,
      std::vector<double>* split_select_weights, ImportanceMode importance_mode, uint64_t min_node_size, uint64_t min_bucket,
      ...
      std::vector<double>* sample_fraction, double alpha, double minprop, bool holdout, uint64_t num_random_splits,
      uint64_t max_depth, std::vector<double>* regularization_factor, bool regularization_usedepth,
