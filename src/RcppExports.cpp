...
// rangerCpp
Rcpp::List rangerCpp(uint64_t treetype, Rcpp::NumericMatrix& input_x, Rcpp::NumericMatrix& input_y, Rcpp::NumericMatrix& obs_weights, std::vector<std::string> variable_names, uint64_t mtry, uint64_t num_trees, bool verbose, uint64_t seed, uint64_t num_threads, bool write_forest, uint64_t importance_mode_r, uint64_t min_node_size, uint64_t min_bucket, std::vector<std::vector<double>>& split_select_weights, bool use_split_select_weights, std::vector<std::string>& always_split_variable_names, bool use_always_split_variable_names, bool prediction_mode, Rcpp::List loaded_forest, Rcpp::RawMatrix snp_data, bool sample_with_replacement, bool probability, std::vector<std::string>& unordered_variable_names, bool use_unordered_variable_names, bool save_memory, uint64_t splitrule_r, std::vector<double>& case_weights, bool use_case_weights, std::vector<double>& class_weights, bool predict_all, bool keep_inbag, std::vector<double>& sample_fraction, double alpha, double minprop, bool holdout, uint64_t prediction_type_r, uint64_t num_random_splits, Eigen::SparseMatrix<double>& sparse_x, bool use_sparse_data, bool order_snps, bool oob_error, uint64_t max_depth, std::vector<std::vector<size_t>>& inbag, bool use_inbag, std::vector<double>& regularization_factor, bool use_regularization_factor, bool regularization_usedepth);
RcppExport SEXP _wranger_rangerCpp(SEXP treetypeSEXP, SEXP input_xSEXP, SEXP input_ySEXP, SEXP obs_weightsSEXP, SEXP variable_namesSEXP, SEXP mtrySEXP, SEXP num_treesSEXP, SEXP verboseSEXP, SEXP seedSEXP, SEXP num_threadsSEXP, SEXP write_forestSEXP, SEXP importance_mode_rSEXP, SEXP min_node_sizeSEXP, SEXP min_bucketSEXP, SEXP split_select_weightsSEXP, SEXP use_split_select_weightsSEXP, SEXP always_split_variable_namesSEXP, SEXP use_always_split_variable_namesSEXP, SEXP prediction_modeSEXP, SEXP loaded_forestSEXP, SEXP snp_dataSEXP, SEXP sample_with_replacementSEXP, SEXP probabilitySEXP, SEXP unordered_variable_namesSEXP, SEXP use_unordered_variable_namesSEXP, SEXP save_memorySEXP, SEXP splitrule_rSEXP, SEXP case_weightsSEXP, SEXP use_case_weightsSEXP, SEXP class_weightsSEXP, SEXP predict_allSEXP, SEXP keep_inbagSEXP, SEXP sample_fractionSEXP, SEXP alphaSEXP, SEXP minpropSEXP, SEXP holdoutSEXP, SEXP prediction_type_rSEXP, SEXP num_random_splitsSEXP, SEXP sparse_xSEXP, SEXP use_sparse_dataSEXP, SEXP order_snpsSEXP, SEXP oob_errorSEXP, SEXP max_depthSEXP, SEXP inbagSEXP, SEXP use_inbagSEXP, SEXP regularization_factorSEXP, SEXP use_regularization_factorSEXP, SEXP regularization_usedepthSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< uint64_t >::type treetype(treetypeSEXP);
    ...
    Rcpp::traits::input_parameter< Rcpp::NumericMatrix& >::type obs_weights(obs_weightsSEXP);
    Rcpp::traits::input_parameter< std::vector<std::string> >::type variable_names(variable_namesSEXP);
    Rcpp::traits::input_parameter< uint64_t >::type mtry(mtrySEXP);
    Rcpp::traits::input_parameter< uint64_t >::type num_trees(num_treesSEXP);
    Rcpp::traits::input_parameter< bool >::type verbose(verboseSEXP);
    Rcpp::traits::input_parameter< uint64_t >::type seed(seedSEXP);
    Rcpp::traits::input_parameter< uint64_t >::type num_threads(num_threadsSEXP);
    Rcpp::traits::input_parameter< bool >::type write_forest(write_forestSEXP);
    Rcpp::traits::input_parameter< uint64_t >::type importance_mode_r(importance_mode_rSEXP);
    Rcpp::traits::input_parameter< uint64_t >::type min_node_size(min_node_sizeSEXP);
    Rcpp::traits::input_parameter< uint64_t >::type min_bucket(min_bucketSEXP);
    ...
    Rcpp::traits::input_parameter< uint64_t >::type splitrule_r(splitrule_rSEXP);
    ...
    Rcpp::traits::input_parameter< uint64_t >::type prediction_type_r(prediction_type_rSEXP);
    Rcpp::traits::input_parameter< uint64_t >::type num_random_splits(num_random_splitsSEXP);
    ...
    Rcpp::traits::input_parameter< uint64_t >::type max_depth(max_depthSEXP);
...
RcppExport SEXP _wranger_randomObsNode(SEXP groupsSEXP, SEXP ySEXP, SEXP inbag_countsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
static const R_CallMethodDef CallEntries[] = {
    {"_wranger_rangerCpp", (DL_FUNC) &_wranger_rangerCpp, 48},
    {"_wranger_numSmaller", (DL_FUNC) &_wranger_numSmaller, 2},
    {"_wranger_randomObsNode", (DL_FUNC) &_wranger_randomObsNode, 3},
    {NULL, NULL, 0}
};

RcppExport void R_init_wranger(DllInfo *dll) {
