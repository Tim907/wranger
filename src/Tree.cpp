...
void Tree::init(const Data* data, uint64_t mtry, size_t num_samples, uint64_t seed, std::vector<size_t>* deterministic_varIDs,
    ...
    double minprop, bool holdout, uint64_t num_random_splits, uint64_t max_depth, std::vector<double>* regularization_factor,
